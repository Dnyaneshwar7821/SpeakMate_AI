  ...
  return (
    <form className="mt-6 space-y-4" onSubmit={handleSubmit} noValidate>
      ...
      <div className="flex items-center justify-between text-sm">
        <label htmlFor={`${role.toLowerCase()}-remember-me`} className="flex items-center gap-2 text-slate-600 font-medium select-none cursor-pointer group">
          <div className="relative flex items-center justify-center">
            ...
            />
            <div className="h-4 w-4 rounded border border-slate-300 bg-white transition-all peer-focus:ring-2 peer-focus:ring-indigo-500/20 peer-checked:bg-indigo-600 peer-checked:border-indigo-600 flex items-center justify-center shadow-xs group-hover:border-slate-400">
              {rememberMe && (
                <svg className="h-3 w-3 text-white stroke-[3]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
