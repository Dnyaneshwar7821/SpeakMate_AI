...
export function UserProgressModal({ user, onClose }) {
    ...
    const progress = user.progress || {
        ...
        level: user.level || 1,
        vocabulary: { percentage: Math.round(user.vocabularyScore || 0), learned: Math.round(user.vocabularyScore || 0), total: 100 },
        grammar: { percentage: Math.round(user.grammarScore || 0), completed: Math.round(user.grammarScore || 0), total: 100 },
        speaking: { percentage: Math.round(user.speakingScore || 0), sessions: Math.round(user.speakingScore || 0), total: 100 },
        listening: { percentage: Math.round(user.listeningScore || 0), lessons: Math.round(user.listeningScore || 0), total: 100 },
    };
