        ...
        return (
            <div className="flex flex-col items-center justify-center gap-4 py-24 text-center">
                ...
                <div className="space-y-1">
                    <p className="text-sm font-semibold text-[var(--text-primary)]">Loading users...</p>
                    <p className="text-xs text-[var(--text-secondary)]">Please wait while user records are being fetched.</p>
                </div>
            </div>
        );
    }
                        ...
                        >
                            ...
                            <td className="px-4 py-3 sm:px-5">
                                <button
                                    ...
                                    className={[
                                        "inline-flex items-center gap-1.5 whitespace-nowrap rounded-full px-2.5 py-1 text-xs font-semibold cursor-pointer hover:opacity-80 transition",
                                        user.status === "active"
