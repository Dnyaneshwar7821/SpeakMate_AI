...
export const ADMIN_SIDEBAR_MENU = [
    ...
    { id: "insights", label: "AI Insights", icon: Sparkles, path: ROUTES.ADMIN_INSIGHTS },
    ...
    { id: "add-school", label: "Schools", icon: Building2, path: ROUTES.ADMIN_ADD_SCHOOL },
    ...
    { id: "notifications", label: "Notifications", icon: Bell, path: ROUTES.ADMIN_NOTIFICATIONS },
];
