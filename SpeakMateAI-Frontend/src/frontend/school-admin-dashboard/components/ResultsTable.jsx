                ...
                <tbody>
                    {results.map((r) => (
                        ...
                        >
                            ...
                            <td className="px-4 py-3 sm:px-5">
                                <span
                                    className={`inline-flex rounded-full px-2.5 py-1 text-xs font-semibold ${isResultPassed(r.status) ? "bg-emerald-500/10 text-emerald-500" : "bg-rose-500/10 text-rose-500"}`}
                                >
                                    {r.status}
                                </span>
                            </td>
