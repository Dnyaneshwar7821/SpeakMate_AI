...
export default function DashboardScreen({ navigation }) {
  ...
  const viewModel = useMemo(() => {
    ...
    return {
      ...
      statistics: {
        ...(d.statistics || {}),
        currentStreak: Math.max(1, Number(d.statistics?.currentStreak || progress.currentStreak || progress.streak || 1)),
        longestStreak: Math.max(1, Number(d.statistics?.longestStreak || progress.longestStreak || 1)),
      },
      quote: d.quote,
