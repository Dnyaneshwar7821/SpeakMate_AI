...
export function TeacherHeader({
    ...
    return (
        <header className="sticky top-0 z-20 flex h-16 shrink-0 items-center border-b border-slate-200/80 bg-white/90 px-4 backdrop-blur-xl sm:px-6 lg:px-8 dark:border-slate-800/80 dark:bg-slate-950/90">
            <button
                ref={menuButtonRef}
                type="button"
                onClick={onMenuOpen}
                className="mr-3 grid h-10 w-10 shrink-0 place-items-center rounded-xl text-slate-600 transition-colors duration-200 hover:bg-slate-100 hover:text-slate-950 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-white lg:hidden"
            ...
            <div className="min-w-0 flex-1">
                <p className="truncate text-sm font-bold text-slate-950 dark:text-slate-50 sm:text-base">
                    {teacherName}
                </p>
