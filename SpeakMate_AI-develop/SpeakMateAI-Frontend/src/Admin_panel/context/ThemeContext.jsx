...
export function ThemeProvider({ children }) {
  const [isDark, setIsDark] = useState(() => {
    const savedAdmin = localStorage.getItem("speakmate_admin_theme");
    if (savedAdmin !== null) {
      return savedAdmin === "dark";
    }
    const savedGeneral = localStorage.getItem("speakmate_theme");
    if (savedGeneral !== null) {
      return savedGeneral === "dark";
    }
  ...
  useEffect(() => {
    ...
    localStorage.setItem("speakmate_admin_theme", themeStr);
    localStorage.setItem("speakmate_theme", themeStr);
  }, [isDark]);
