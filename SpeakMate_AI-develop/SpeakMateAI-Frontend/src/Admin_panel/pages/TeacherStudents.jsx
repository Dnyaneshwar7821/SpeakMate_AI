        ...
        <motion.div variants={containerVariants} initial="hidden" animate="visible">
            ...
            <motion.section variants={itemVariants} className="mt-8" aria-label="Student search and filters">
                <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-2 lg:grid-cols-12 items-center">
                    <label className="relative block w-full lg:col-span-3">
                    ...
                    <label className="relative block w-full lg:col-span-3">
                        ...
                        <select
                            ...
                            className="h-11 w-full cursor-pointer appearance-none rounded-xl border border-slate-200 bg-white pl-11 pr-7 text-xs sm:text-xs font-semibold text-slate-900 shadow-sm outline-none transition focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-100 dark:focus:ring-indigo-950/50"
                        >
                    ...
                    <label className={`relative block w-full ${assignedDivisions.length > 0 ? "lg:col-span-3" : "lg:col-span-6"}`}>
                        ...
                        <select
                            ...
                            className="h-11 w-full cursor-pointer appearance-none rounded-xl border border-slate-200 bg-white pl-14 pr-7 text-xs sm:text-xs font-semibold text-slate-900 shadow-sm outline-none transition focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-100 dark:focus:ring-indigo-950/50"
                        >
