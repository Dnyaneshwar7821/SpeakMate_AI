	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http.csrf(AbstractHttpConfigurer::disable)
				...
				.authorizeHttpRequests(auth -> auth
						...
						// Notifications for all authenticated users (Student, Teacher, School Admin, Platform Admin)
						...
						.requestMatchers("/api/users/**", "/api/lessons/**", "/api/lesson/**", "/api/speech/**", 
								...
								"/api/ai/**", "/api/onboarding/**")
						.hasAnyAuthority("ROLE_USER", "ROLE_STUDENT", "ROLE_TEACHER")
						
						// Profile and Settings accessible by all roles (USER, STUDENT, TEACHER, SCHOOL_ADMIN, SUPER_ADMIN)
						.requestMatchers("/api/profile/**", "/api/settings/**", "/api/user/**")
						.hasAnyAuthority("ROLE_USER", "ROLE_STUDENT", "ROLE_TEACHER", "ROLE_SCHOOL_ADMIN", "ROLE_SUPER_ADMIN")
